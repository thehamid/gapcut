...
const ProfileMedias = dynamic(() => import('@/components/user/profile/ProfileMedias'), { ssr: false })
...
const Tracking = async ({params}) => {
  ...
  return (
    ...
    {(!userData) ? <Loading style={'h-screen'} /> : 
        ...
        <div>
        <ProfileHeader data={userData} page={'tracking'} >
            <ProfileMedias data={userData.tracks} />
        </ProfileHeader>
        </div>  
    }
    </div>
